...
using ProgrammingAssignments.AnotherGraphs;
using ProgrammingAssignments.HLD;
...
namespace ProgrammingAssignments
{
    class Program
    {
        ...
        {
            new Bridges().solve(5, new List<List<int>>() {
                new() { 1, 2 },
                new() { 1, 4 },
                new() { 4, 5 },
                new() { 5, 2 },
            ...
            new NumberOfIslands().solve(new List<List<int>>() { new() { 0, 0, 1, 0, 1, 0, 1, 1, 1 },new() { 0, 1, 0, 0, 1, 1, 1, 0, 1 } });
